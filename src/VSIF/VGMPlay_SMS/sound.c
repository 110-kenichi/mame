...
//                       Volume 0              ,
const char PSGInit[] = { 0x9f, 0xbf, 0xdf, 0xff, 0x81, 0x00, 0xa1, 0x00, 0x00, 0xc1, 0x00 };

bool playingPcm = false;
...
void PlayPcmSound(const void *data) __z88dk_fastcall
{
    playingPcm = true;
