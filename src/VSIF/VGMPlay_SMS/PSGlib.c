...
unsigned char PSGChan0LowTone;             // the low tone bits for channels 0
unsigned char PSGChan1LowTone;             // the low tone bits for channels 1
...
;itoken
  bit 5,a
  jr nz,_low_part_Tone0
_low_part_Tone1:
  ld (_PSGChan1LowTone),a
  jp _low_part_01_end
_low_part_Tone0:
  ld (_PSGChan0LowTone),a
_low_part_01_end:
...
;itoken
  bit 5,a
  jr nz,_high_part_Tone0
_high_part_Tone1:
  ld (_PSGChan1HighTone),a
  jp _high_part_01_end
_high_part_Tone0:
  ld (_PSGChan0HighTone),a
_high_part_01_end:
