...
void (*SMS_theNmiInterruptHandler)(void) = nop;
...
void SMS_setNmiInterruptHandler (void (*theHandlerFunction)(void)) __z88dk_fastcall {
  SMS_theNmiInterruptHandler=theHandlerFunction;
}
