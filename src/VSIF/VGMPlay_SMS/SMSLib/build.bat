...
sdcc -o SMSlib_UNSAFE_zx7.rel -c -mz80 %OPT% SMSlib_UNSAFE_zx7.c
@if %errorlevel% NEQ 0 goto :EOF
...
sdar r SMSlib.lib SMSlib.rel SMSlib_sprite.rel SMSlib_twosprites.rel SMSlib_paletteAdv.rel SMSlib_spriteAdv.rel SMSlib_spriteClip.rel SMSlib_PSGaiden.rel SMSlib_STMcomp.rel SMSlib_loadTileMapArea.rel SMSlib_loadTiles.rel SMSlib_load1bppTiles.rel SMSlib_VRAMmemcpy.rel SMSlib_VRAMmemset.rel SMSlib_UNSAFE.rel SMSlib_textrenderer.rel SMSlib_autotext.rel SMSlib_zx7.rel SMSlib_UNSAFE_zx7.rel SMSlib_aPLib.rel SMSlib_paddle.rel SMSlib_deprecated.rel
@if %errorlevel% NEQ 0 goto :EOF

sdar r SMSlib_GG.lib SMSlib_GG.rel SMSlib_sprite.rel SMSlib_twosprites.rel SMSlib_paletteAdv.rel SMSlib_spriteAdv.rel SMSlib_spriteClip_GG.rel SMSlib_PSGaiden.rel SMSlib_STMcomp.rel SMSlib_loadTileMapArea.rel SMSlib_loadTiles.rel SMSlib_load1bppTiles.rel SMSlib_VRAMmemcpy.rel SMSlib_VRAMmemset.rel SMSlib_UNSAFE.rel SMSlib_textrenderer.rel SMSlib_autotext_GG.rel SMSlib_zx7.rel SMSlib_UNSAFE_zx7.rel SMSlib_aPLib.rel SMSlib_deprecated.rel
@if %errorlevel% NEQ 0 goto :EOF
