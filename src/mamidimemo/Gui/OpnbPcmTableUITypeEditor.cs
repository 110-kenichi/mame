...
namespace zanac.MAmidiMEmo.Gui
{
    ...
    /// 
    /// </summary>
    public class OpnbPcmTableUITypeEditor : ArrayEditor
    {
        /// <summary>
        /// 
        /// </summary>
        /// <param name="type"></param>
        public OpnbPcmTableUITypeEditor(Type type) : base(type)
        {
        }
        ...
        public override object EditValue(ITypeDescriptorContext context, IServiceProvider provider, object value)
        {
            ...
            using (FormOpnbPcmTableEditor frm = new FormOpnbPcmTableEditor())
            {
