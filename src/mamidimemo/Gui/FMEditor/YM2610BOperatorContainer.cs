...
{
    public partial class YM2610BOperatorContainer : RegisterContainerBase
    {
        private YM2610B.YM2610BOperator op;
        ...
        /// 
        /// </summary>
        public YM2610BOperatorContainer(YM2610B.YM2610BOperator op, string name) : base(op, name)
        {
            InitializeComponent();
