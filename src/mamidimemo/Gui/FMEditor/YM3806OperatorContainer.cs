...
{
    public partial class YM3806OperatorContainer : RegisterContainerBase
    {
        private YM3806.YM3806Operator op;
        ...
        /// 
        /// </summary>
        public YM3806OperatorContainer(YM3806.YM3806Operator op, string name) : base(op, name)
        {
            InitializeComponent();
            ...
            AddControl(new RegisterValue("DT1", op.DT1, 0, 63));
            AddControl(new RegisterValue("AM", op.AM, 0, 1));
            AddControl(new RegisterValue("OSCW", op.OSCW, 0, 1));
