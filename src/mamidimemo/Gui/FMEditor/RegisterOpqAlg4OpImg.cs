...
{
    public partial class RegisterOpqAlg4OpImg : RegisterBase
    {
        ...
        /// 
        /// </summary>
        public RegisterOpqAlg4OpImg(RegisterValue alg) : base("OpqAlg4OpImg ")
        {
            DoubleBuffered = true;
        ...
        private void Alg_ValueChanged(object sender, PropertyChangedEventArgs e)
        {
            ...
            switch (alg.Value)
            {
                ...
                case 3:
                    ...
                    break;
                case 4:
                    this.BackgroundImage = Resources.ALG5Q;
                    break;
                case 5:
                ...
                case 6:
                    ...
                    break;
                case 7:
                    this.BackgroundImage = Resources.ALG8Q;
                    break;
            }
        }
    }
