...
{
    public partial class YM2608OperatorContainer : RegisterContainerBase
    {
        private YM2608.YM2608Operator op;
        ...
        /// 
        /// </summary>
        public YM2608OperatorContainer(YM2608.YM2608Operator op, string name) : base(op, name)
        {
            InitializeComponent();
