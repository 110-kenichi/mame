...
{
    public class InstGeneralTab : PropertiesTab
    {
        ...
        public override PropertyDescriptorCollection GetProperties(ITypeDescriptorContext context, object component, Attribute[] attributes)
        {
            ...
            if (!(component is Instruments.InstrumentBase))
                return props;
            ...
            foreach (PropertyDescriptor p in props)
            {
                ...
                if (atr != null && string.Equals(atr.Category, TabName, StringComparison.Ordinal))
                    pdlist.Add(p);
            }
