            ...
            public override void OnVolumeUpdated()
            {
                switch (lastToneType)
                {
                    case ToneType.FM:
                        ...
                        {
                            //$40+: total level
                            YM2610BWriteData(unitNumber, 0x40, op, Slot, (byte)((127 / 3) - Math.Round(((127 / 3) - (timbre.Ops[op].TL / 3)) * v)));
                        }
                        break;
                    case ToneType.SSG:
                        updatePsgVolume();
...
#region FM Synth
    ...
    "ALG, FB, AR, D1R(DR), D2R(SR), RR, SL, TL, RS(KS), MUL, DT1, AM(AMS), SSG_EG, ...\r\n" +
        ...
        [DataContract]
        [InstLock]
        public class YM2610BOperator : InstLockProxy
        {
...
#region Etc
        ...
        [DataContract]
        [InstLock]
        public class YM2610BGlobalSettings : InstLockProxy
        {
            [DataMember]
            [Category("Chip")]
