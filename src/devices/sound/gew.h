...
public:
	...
	u8 read_byte(offs_t byteaddress) { return wave_memory[byteaddress & 0x3FFFFF]; }
	void write_byte(offs_t byteaddress, u8 data) { wave_memory[byteaddress & 0x3FFFFF] = data; }

protected:
	u8 wave_memory[4 * 1024 * 1024]; // up to 4MB
