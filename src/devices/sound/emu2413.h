#ifndef MAME_SOUND_EMU2413_H
#define MAME_SOUND_EMU2413_H
...
class emu2413_device : public device_t, public device_sound_interface
{
public:
	emu2413_device(const machine_config &mconfig, const char *tag, device_t *owner, uint32_t clock);
...
DECLARE_DEVICE_TYPE(EMU2413, emu2413_device)

#endif // MAME_SOUND_EMU2413_H
