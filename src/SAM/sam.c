...
unsigned char stress[258]; //numbers from 0 to 8
unsigned char phonemeLength[258]; //tab40160
unsigned char phonemeindex[258];
...
__declspec(dllexport) char* GetBuffer(){return buffer;}
__declspec(dllexport) int GetBufferLength(){return bufferpos;}
