================================================================================
MICROSOFT FOUNDATION CLASS ライブラリ: c86win プロジェクトの概要
===============================================================================

アプリケーション ウィザードが作成した c86win には Microsoft 
Foundation Class の基本的な使い方が示されています。アプリケーション作成のひな型
としてお使いください。

このファイルには c86win アプリケーションを構成している各ファイ
ルの概要説明が含まれます。
...
c86win.h
   ...
   C86winApp アプリケーション クラスを宣言します。

c86win.cpp
   これは、アプリケーション クラス C86winApp を含むメイン アプリケー
   ション ソース ファイルです。
...
res\c86win.ico
   ...
   アイコンはメイン リソース ファイル c86win.rc に含まれていま
   す。
...
c86winDlg.h, c86winDlg.cpp - ダイアログ
   これらのファイルは Cc86winDlg クラスを含みます。このクラスはアプ
   リケーションのメイン ダイアログの動作を定義します。ダイアログ テンプレートは
   Microsoft Visual C++ で編集可能な c86win.rc に含まれます。
...
StdAfx.h, StdAfx.cpp
   ...
   c86win.pch や既にコンパイルされた型のファイル StdAfx.obj を
   ビルドするために使用されます。
