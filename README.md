...
2.4.0.1 Improved UI.
		Supported formula for SoundControlChangeSettings and GeneralPurposeControlSettings properties.
		Added Data Entry to Piano GUI. Use Mouse Wheel to change the value.
